...
:imagesdir: ../assets/images/module3
...
image:application-architecture.png[width=80%]
...
image:details-failed-status.png[]
...
image:acs-signature-integration.png[]
...
image:advanced-devsecops-pipelinerun.png[]
...
image:advanced-pipeline-steps-1.png[]
...
image:advanced-pipeline-steps-2.png[]
...
image:gitops-update-manifest.png[]
...
image:gitea-updated-manifest.png[]
...
image:gitops-application-globex.png[]
...
image:gitops-app-details-more.png[]
