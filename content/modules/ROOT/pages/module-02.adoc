...
* remove the *namespace* line from the file:
  labels:
...
* Before leaving the cluster. Copy the RHSI URL and paste in your web browser. You will need it in the next section.

For example: https://skupper-coolstore-user2.apps.cluster-kbzn7.kbzn7.sandbox3018.opentlc.com/
