...
1. Select the new Service.
2. On the right menu, Click on the *Resources* tab

image::module1/serverless_resources.png[width=80%]

1. Click on the *View Logs*
2. Verify that the build is running and that the logs have no issues.
...
6. On Resource Type, select *Deployment*
7. Name: catalog-spring-boot 
...
* Select the Service revision on the topology 
...
image::module1/view_dashboard.png[width=60%]
